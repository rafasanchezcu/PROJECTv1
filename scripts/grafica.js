...
var marker_bus0 = 'img/busmorado.svg',
  	...
  	marker_estacion = 'img/estacion.svg';
...
//codigo encargado de crear la grafica
 ...
 $('#container').highcharts({
     ...
     xAxis: {
         categories: ['Hipótesis ideal', 'Simulación 1<br>Hora salida: 6:00', 'Simulación 2<br>Hora salida: 6:10','Simulación 3<br>Hora salida: 6:20']
     },
     yAxis: {
         min: 0,
         title: {
